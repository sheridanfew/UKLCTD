# Script to assign rurality type to Scottish datazones based upon meter density (no longer used since Scottish Gov't assignment of rurality types per data zone was discovered)
...
write.csv(UKPVD_df, paste(output_path,'UKPVD_w_substations_w_Scot_Rurality_Oct2020.csv', sep=''), row.names=FALSE)
